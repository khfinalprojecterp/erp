...
<body>
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="panel panel-default">
                  <div class="panel-heading">작업 지시서 조회
                     <button style="float:right" type="button" class="btn btn-primary" data-toggle="modal" data-target="#insertMaterialscate">기자재 분류 추가</button>
                  </div>
   ...
   <script>      
      /* function fn_goMaterialsCategoryInsert() {
         location.href = "${pageContext.request.contextPath}/materialscate/mateCateInsert.do";
      } */
